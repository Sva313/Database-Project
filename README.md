...
We started off by gathering any existing data that will be included in the database. Then listed the types of data we stored and the entities that they describe like this:
